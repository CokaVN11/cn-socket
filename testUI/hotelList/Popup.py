...
class popupWindow(object):
    def __init__(self,master):
        ...
        #========================= Confirm Button =========================#
        self.confirmBtn = Button(top, text='Comfirm', font=(15), command=self.confirmAndOut)
        self.confirmBtn.grid(row = 4, column = 1, pady = 20)

        #==================== Calendar for Depart Date ====================#
        self.departTitle = Label(top,
...
class mainWindow(object):
    ...
    def popup(self):
        self.popupScreen = popupWindow(self.master)
