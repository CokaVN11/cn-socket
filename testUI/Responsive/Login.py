...
def SignupScreen():
    ...
    SignupBackground = canvas.create_image(
        convertSize(806.5), convertSize(303.0),
    ...
    SignupBackButton = Button(
        ...
        x = convertSize(24), y = convertSize(20),
    ...
    SignupEntry1Background = canvas.create_image(
        convertSize(800), convertSize(270),
        image = Signup_Entry
    )
    ...
    SignupEntry1.place(
        x = convertSize(536), y = convertSize(226) + EntryDiscrepancy,
    ...
    SignupEntry2Background = canvas.create_image(
        convertSize(800), convertSize(429),
        image = Signup_Entry
    )
    ...
    SignupEntry2.place(
        x = convertSize(536), y = convertSize(385) + EntryDiscrepancy,
        width = convertSize(528),
        height = EntryHeight
    )
    ...
    SignupEntry3Background = canvas.create_image(
        convertSize(800), convertSize(590),
        image = Signup_Entry
    )
    ...
    SignupEntry3.place(
        x = convertSize(536), y = convertSize(546) + EntryDiscrepancy,
        width = convertSize(528),
        height = EntryHeight
    )
    ...
    SignupSubmitButton = Button(
        ...
        x = convertSize(520), y = convertSize(705),
