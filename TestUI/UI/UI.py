...
#-------------------------------- Save image --------------------------------#
# LOGIN PAGE
LoginCreateOneButton = PhotoImage(
    file=relative_to_assets("LoginCreateOne.png"))
LoginButton = PhotoImage(
    file=relative_to_assets("LoginLogin.png"))
LoginEntry1 = PhotoImage(
    file=relative_to_assets("LoginEntry1.png"))
LoginEntry2 = PhotoImage(
    file=relative_to_assets("LoginEntry2.png"))
