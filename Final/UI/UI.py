...
Signup_Background = convertImage("./assets/Signup_Background.png", 547, 470)
...
Signup_SubmitButton = convertImage("./assets/Signup_SubmitButton.png", 560, 88)
...
def LoginScreen():
    ...
    LoginBackground = canvas.create_image(
        convertSize(724.0), convertSize(450.0), image=Login_Background
    )

    # ---------- Entry Username
    LoginEntry1Background = canvas.create_image(
        convertSize(1201), convertSize(304), image=Login_Entry
    )
    LoginEntry1 = Entry(bd=0, bg="#ffffff", highlightthickness=0, font=(EntryFontSize))
    LoginEntry1.place(
        x=convertSize(962),
    ...
    LoginEntry2Background = canvas.create_image(
        convertSize(1201.0), convertSize(459.0), image=Login_Entry
    )
    LoginEntry2 = Entry(bd=0, bg="#ffffff", highlightthickness=0, font=(EntryFontSize))
    LoginEntry2.place(
        x=convertSize(962),
...
def SignupScreen():
    ...
    SignupBackground = canvas.create_image(
        convertSize(806.5), convertSize(303.0), image=Signup_Background
    )
    ...
    SignupEntry1Background = canvas.create_image(
        convertSize(800), convertSize(270), image=Signup_Entry
    )

    SignupEntry1 = Entry(bd=0, bg="#ffffff", highlightthickness=0, font=(EntryFontSize))
    SignupEntry1.place(
        x=convertSize(536),
    ...
    SignupEntry2Background = canvas.create_image(
        convertSize(800), convertSize(429), image=Signup_Entry
    )

    SignupEntry2 = Entry(bd=0, bg="#ffffff", highlightthickness=0, font=(EntryFontSize))
    SignupEntry2.place(
        x=convertSize(536),
    ...
    SignupEntry3Background = canvas.create_image(
        convertSize(800), convertSize(590), image=Signup_Entry
    )

    SignupEntry3 = Entry(bd=0, bg="#ffffff", highlightthickness=0, font=(EntryFontSize))
    SignupEntry3.place(
        x=convertSize(536),
    ...
    def checkFieldValid(typeCheck, userInput):
        if typeCheck == "username":
            ...
            if len(userInput) < 3:
                messagebox.showinfo(
                    "Invalid input", "Password must have at least 3 characters"
                )
                return False
